<?php require_once 'C:\xampp\htdocs\freshleaf_website\mvc\controller\ReviewController.php';
    ...
    <div id="product-list">
        ...
        <?php if (!empty($data['orderProduct'])): ?>
            <?php foreach ($data['orderProduct'] as $product): ?>
                ...
                <div class="product">
                    <form action="/freshleaf_website/review/addReview" method="POST">
...
<script src="\freshleaf_website\Public\js\review.js"></script>
</body>
</html>