...
<head>
    ...
    <link rel="stylesheet" href="/freshleaf_website/public/css/editProduct.css?v=<?php echo time();?>">
    <title>Document</title>
</head>
<body>
    <div class="back">
        
        <a href="/freshleaf_website/Admin/ProductManager"><button><i class="fa fa-angle-double-left" style="font-size:30px"></i>Back</button></a>
    </div>
