...
<head>
    ...
    <title>Payment</title>
    <link rel="stylesheet" href="/freshleaf_website/public/css/order.css?v=<?php echo time();?>">
    <script src="/freshleaf_website/public/js/order.js"></script>
            ...
            <div class="payment-info">
                <form action="" method="POST">
                    ...
                    <div class="option-method">
                        <a href="#">
                            <img src="/freshleaf_website/public/images/ATM.jpg" alt="">
                            <p>Bank Transfer</p>
                        </a>
                        <a href="#">
                            <img src="/freshleaf_website/public/images/coin.jpg" alt="">
