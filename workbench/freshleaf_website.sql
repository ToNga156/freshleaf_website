...
(3, 'Cải Thảo', 'Cải thảo là loại rau có lá mềm và bẹ trắng, thường được sử dụng trong các món kimchi, canh, hoặc lẩu, mang lại hương vị thanh ngọt.', 26000.00, 30, 'https://img.lovepik.com/free-png/20210919/lovepik-chinese-cabbage-png-image_400288432_wh1200.png', 1),
...
(7, 'Cà rốt Hàn Quốc', 'Cà rốt Hàn Quốc giàu beta-carotene, vitamin A, và chất chống oxy hóa, giúp tăng cường thị lực, làm đẹp da và hỗ trợ sức khỏe tim mạch. Được trồng trong điều kiện khí hậu lý tưởng, cà rốt Hàn Quốc có vị ngọt thanh tự nhiên và kết cấu giòn ngon.', 50000.00, 100, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\carot.jpg\"', 2),
(8, 'Củ dền đỏ', 'Củ rền đỏ - loại củ giàu dinh dưỡng với màu đỏ đậm tự nhiên, chứa nhiều vitamin, khoáng chất và chất chống oxy hóa. Vị ngọt thanh, dễ dàng chế biến trong các món ăn như salad, nước ép, súp hoặc món xào, mang đến sức khỏe và hương vị tuyệt vời cho gia đình bạn.', 15000.00, 0, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\curendo.jpg\"', 2),
(9, 'Bắp ngô Nếp vàng', 'Bắp ngô tươi - loại ngũ cốc giàu dinh dưỡng, với hạt vàng óng, vị ngọt tự nhiên và giàu chất xơ. Phù hợp để chế biến các món ăn như luộc, nướng, súp, hoặc làm nguyên liệu cho món bánh và đồ ăn nhẹ bổ dưỡng.', 20000.00, 20, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\bapngo.jpg\"', 5),
(10, 'Chanh tươi', 'Chanh tươi - loại quả nhỏ với vỏ mỏng, màu xanh tươi sáng, giàu vitamin C và hương thơm tự nhiên. Hoàn hảo để pha nước giải khát, làm gia vị cho món ăn, hoặc tạo điểm nhấn trong các món tráng miệng.', 50000.00, 100, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\chanh.jpg\"', 3),
(11, 'Cà tím', 'Cà tím - loại quả màu tím bóng bẩy, thịt mềm, giàu chất xơ và các chất chống oxy hóa. Dễ dàng chế biến thành các món xào, nướng, hầm, hoặc làm nguyên liệu cho các món ăn chay ngon miệng và bổ dưỡng.', 25000.00, 30, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\catim.jpg\"', 2),
(12, 'Ớt chuông', 'Ớt chuông - loại quả với màu sắc rực rỡ (đỏ, vàng, xanh), giàu vitamin C, chất chống oxy hóa và hương vị ngọt dịu. Thích hợp để chế biến các món xào, nướng, salad hoặc dùng làm nguyên liệu trang trí món ăn, mang lại hương vị và màu sắc hấp dẫn.', 25000.00, 10, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\otchuong.jpg\"', 3),
(13, 'Rau muống', 'Rau muống - loại rau xanh quen thuộc, giòn ngon, giàu chất xơ, sắt và các vitamin thiết yếu. Phù hợp để chế biến các món xào, luộc, hoặc nấu canh, mang đến bữa ăn bổ dưỡng và thanh mát cho gia đình.', 20000.00, 20, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\raumuong.jpg\"', 1),
(14, 'Súp lơ xanh', 'Súp lơ xanh - loại rau giàu dinh dưỡng với hình dáng đẹp mắt, chứa nhiều vitamin C, chất xơ và chất chống oxy hóa. Vị ngọt tự nhiên, giòn ngon, phù hợp để chế biến các món xào, luộc, hấp hoặc làm nguyên liệu trong món salad và súp bổ dưỡng', 25000.00, 8, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\suplo.jpg\"', 1),
(15, 'Rau xà lách Nhật', 'Rau xà lách - loại rau lá mềm, xanh mướt, giàu vitamin và khoáng chất, mang hương vị thanh nhẹ và tươi mát. Thích hợp để ăn sống, làm salad, cuốn gỏi hoặc trang trí món ăn, mang đến sự tươi ngon và dinh dưỡng cho bữa ăn của bạn.', 15000.00, 45, '\"D:\\sampp\\htdocs\\freshleaf_website\\public\\images\\rau_xalach.jpg\"', 1);
...
(1, '2024-12-19 01:39:55', 'pending', 1),
(2, '2024-12-19 01:39:55', 'completed', 2),
(3, '2024-12-19 01:39:55', 'completed', 4),
(4, '2024-12-19 01:39:55', 'cancelled', 3),
(5, '2024-12-19 01:39:55', 'pending', 5);
